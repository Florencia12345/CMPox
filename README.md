**CMPox** is a project focused on the fundamental calculations in X-ray and neutron scattering, specifically related to attenuation factors, Curie-Weiss analysis, structure factors, and X-ray computations.
